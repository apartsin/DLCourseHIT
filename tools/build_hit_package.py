...
def build_rationale():
    ...
    he(d, "הקורס מיועד לסטודנטים בשנה השנייה לתואר ראשון במדעי המחשב, שסיימו קורס מבוא בלמידת מכונה. הוא מהווה את קורס היסוד שעליו נשענים קורסי הבחירה המתקדמים במודלי שפה גדולים ובראייה ממוחשבת.")
